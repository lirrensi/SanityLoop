...
import { loadFileKindAndText, type LFile } from "./file-kind.ts";
import { resolveTarget } from "./fs-write.ts";
import { toCwd } from "./paths.ts";
import { detectEnding, toLF, stripBOM, type LineEnding } from "./replace-diff.ts";
import { abortIf } from "./utils.ts";
import { valKind, valAccess } from "./validation.ts";
import { visLines } from "./utils.ts";
