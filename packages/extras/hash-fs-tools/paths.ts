...
export function configDir(): string {
  return overriddenDir ?? join(configBase(), "pi-hashline-edit-pro");
}

/** Factory knob: point the config/hash-store at a custom directory. */
let overriddenDir: string | undefined;
