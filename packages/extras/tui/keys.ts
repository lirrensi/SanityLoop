 ...
 *
 * VENDORED VERBATIM from pi (https://github.com/earendil-works/pi), file
 * packages/tui/src/keys.ts at v0.84.x. MIT License, Copyright (c) 2025
 * Mario Zechner. Zero imports, pure functions — the only piece of pi-tui we
 * take. Everything around it is SanityLoop-built.
 *
